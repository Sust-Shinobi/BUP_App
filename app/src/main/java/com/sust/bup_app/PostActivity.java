...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectImage = findViewById(R.id.idImageButton);
        mPostTitle = findViewById(R.id.idPostTitle);
        mPostDesc = findViewById(R.id.idPostDescription);
        mSubmitBtn = findViewById(R.id.idSubmitPost);
